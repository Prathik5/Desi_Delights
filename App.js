...
const RestrauntCart = ( {cloudinaryImageId, name, cuisines, city, costForTwo} ) => {
  // console.log(props)
  return(
...
const Body = () =>{
  return(
    <div className="restaurant-list">
      ...
      {/* <RestrauntCart {...restaurantList[1].data} />
      <RestrauntCart {...restaurantList[2].data} />
      <RestrauntCart {...restaurantList[3].data} />
      <RestrauntCart {...restaurantList[4].data} />
      <RestrauntCart {...restaurantList[5].data} />
      <RestrauntCart {...restaurantList[6].data} />
      <RestrauntCart {...restaurantList[7].data} />
      <RestrauntCart {...restaurantList[8].data} />
      <RestrauntCart {...restaurantList[9].data} />
      <RestrauntCart {...restaurantList[10].data} /> */}
    </div>
  )
}
